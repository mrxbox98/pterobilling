...
use Pterobilling\LaraExtension\Repository\NamespacedRepository;
...
class InputSpec
{
  ...
  /**
   * @var \Pterobilling\LaraExtension\Specs\Translator
   */
  protected $translator;

  /**
   * @param \Pterobilling\LaraExtension\Repository\NamespacedRepository $specs
