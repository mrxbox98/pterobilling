...
use Pterobilling\Generators\Php\Constant;
use Pterobilling\Generators\Php\ClassName;
...
class Generator
{
  ...
  protected function generateLaravel(FileGenerator $generator, array $properties)
  {
    $generator->directory('classes', function ($generator) use ($properties) {
      $generator->directory('Providers')
        ->file('AddonServiceProvider.php')->template('AddonServiceProvider.php', $properties);
  ...
  protected function generateLaravelAuth(FileGenerator $generator, array $properties)
  {
    $generator->directory('classes', function ($generator) use ($properties) {
